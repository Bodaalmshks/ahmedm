...
os.execute('lua BodaAlmoSHks.lua')
end
...
print('\n\27[1;34m Welcome to the all-new and powerful Source BodaAlmoSHks ')
file = io.open("BodaAlmoSHks", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/BodaAlmoSHks
token="]]..database:get(id_server..":token")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BodaAlmoSHks.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S BodaAlmoSHks -X kill
screen -S BodaAlmoSHks ./BodaAlmoSHks
done
]])  
file:close() 
...
if hash or SudoBot(msg) or DevBodaAlmoSHksW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBodaAlmoSHksW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBodaAlmoSHksW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBodaAlmoSHksW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBodaAlmoSHksW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBodaAlmoSHksW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBodaAlmoSHksW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local BodaAlmoSHks_Msg = ''  
if msgs < 100 then 
BodaAlmoSHks_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BodaAlmoSHks_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BodaAlmoSHks_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BodaAlmoSHks_Msg = 'متفاعل' 
elseif msgs < 1200 then 
BodaAlmoSHks_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BodaAlmoSHks_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BodaAlmoSHks_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BodaAlmoSHks_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BodaAlmoSHks_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
BodaAlmoSHks_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BodaAlmoSHks_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BodaAlmoSHks_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
BodaAlmoSHks_Msg = 'رب التفاعل'  
end 
return BodaAlmoSHks_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@Boda_Almsks")  
...
--------------------------------------------------------------------------------------------------------------
function Source(msg,data) -- بداية العمل
if msg then
...
if DevBodaAlmoSHksW(msg) then
local bl = ' ❃∫ اهلا عزيزي آلمـطـور\n ❃∫ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ❃∫ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ❃∫ من خلاال الكيبورت خاص بك\n ❃∫ قناة سورس البوت [اضغط هنا](t.me/bostatalmshks)'
local keyboard = {
...
if start then 
SourceBodaAlmoSHksr = start
else
SourceBodaAlmoSHksr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الكروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/bostatalmshks)'
end 
send(msg.chat_id_, msg.id_, SourceBodaAlmoSHksr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevBodaAlmoSHksW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevBodaAlmoSHksW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,BodaAlmoSHks_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevBodaAlmoSHksW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevBodaAlmoSHksW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevBodaAlmoSHksW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevBodaAlmoSHksW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevBodaAlmoSHksW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevBodaAlmoSHksW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevBodaAlmoSHksW(msg) then 
...
if text == 'تحديث السورس ❃' and DevBodaAlmoSHksW(msg) then 
os.execute('rm -rf BodaAlmoSHks.lua')
os.execute('wget https://raw.githubusercontent.com/BodaAlmoSHksTEAM/BodaAlmoSHks/master/BodaAlmoSHks.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس بودا\n ❃∫ الاصدار » { 6.7v}')
dofile('BodaAlmoSHks.lua')  
end
if text == 'تحديث المتجر ❃' and DevBodaAlmoSHksW(msg) then 
  io.popen("mkdir File_Bot")
  io.popen("cd File_Bot && rm -rf ga.lua.1") 
  io.popen("cd File_Bot && rm -rf ga.lua.2") 
  io.popen("cd File_Bot && rm -rf ga.lua.3") 
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/BodaAlmoSHksTEAM/Files_BodaAlmoSHks/master/File_Bot/ga.lua")  
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/BodaAlmoSHksTEAM/Files_BodaAlmoSHks/master/File_Bot/rd.lua") 
  send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث \n ❃∫ لديك اخر اصدار للمتجر')
  dofile('BodaAlmoSHks.lua')  
  end
if text == 'رقم البناء ❃' and DevBodaAlmoSHksW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اهلاء عزيزي \n رقم البناء خاص بوتك {lua~{m7a29}')
end
if text == 'الاصدار ❃' and DevBodaAlmoSHksW(msg) then 
  database:del(bot_id..'Srt:Bot') 
  send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس بودا \n ❃∫ الاصدار »{ 6.7v}')
  end
  if text == 'مطور السورس ❃' and DevBodaAlmoSHksW(msg) then 
    database:del(bot_id..'Srt:Bot') 
    send(msg.chat_id_, msg.id_,' ❃∫ تنويه : قبل لا تراسل المطور تاكد انو عندك شغله مهمه \n\n المطور - @Boda_Almsks ')
    end
if text == 'قناه تحديثات البوت ❃' and DevBodaAlmoSHksW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/bostatalmshks) \n ❃∫ [قناه السورس](t.me/bostatalmshks)')
end
if text == "ضع اسم للبوت ❃" and DevBodaAlmoSHksW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevBodaAlmoSHksW(msg) then 
...
if text == 'المشتركين ❃' and DevBodaAlmoSHksW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevBodaAlmoSHksW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevBodaAlmoSHksW(msg) then
...
if text == ("قائمه العام ❃") and DevBodaAlmoSHksW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevBodaAlmoSHksW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevBodaAlmoSHksW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevBodaAlmoSHksW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevBodaAlmoSHksW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevBodaAlmoSHksW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevBodaAlmoSHksW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevBodaAlmoSHksW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevBodaAlmoSHksW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevBodaAlmoSHksW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local BodaAlmoSHks = (w + q)
local sendok = #group - BodaAlmoSHks
if q == 0 then
BodaAlmoSHks = ''
else
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..BodaAlmoSHksk..''..BodaAlmoSHks..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevBodaAlmoSHksW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevBodaAlmoSHksW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevBodaAlmoSHksW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevBodaAlmoSHksW(msg) then
...
local BodaAlmoSHks1_Msg = database:get(bot_id.."BodaAlmoSHks1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BodaAlmoSHks1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if BodaAlmoSHks_Msg and not Special(msg) then  
local BodaAlmoSHks_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BodaAlmoSHks_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..BodaAlmoSHks_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](t.me/bostatalmshks)}\n ❃∫ ["..BodaAlmoSHks_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](t.me/bostatalmshks)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBodaAlmoSHksW(msg) then
...
'\n ❃∫ الرابط {['..LinkGp..']}'
if not DevBodaAlmoSHksW(msg) then
sendText(SUDO,Text,0,'md')
end
end
end,nil) 
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBodaAlmoSHksW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevBodaAlmoSHksW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevBodaAlmoSHksW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevBodaAlmoSHksW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevBodaAlmoSHksW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevBodaAlmoSHksW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevBodaAlmoSHksW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevBodaAlmoSHksW(msg) then  
...
database:sadd(bot_id.."BodaAlmoSHks:blocname"..msg.chat_id_, BlNe)
end
...
database:srem(bot_id.."BodaAlmoSHks:blocname"..msg.chat_id_, delBn)
end

if text == "مسح الاسماء المكتومه" and Constructor(msg) and database:get(bot_id.."block:name:stats"..msg.chat_id_) == "open" then
database:del(bot_id.."BodaAlmoSHks:blocname"..msg.chat_id_)
...
local All_name = database:smembers(bot_id.."BodaAlmoSHks:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_BodaAlmoSHks = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_BodaAlmoSHks then 
names_BodaAlmoSHks = database:smembers(bot_id.."BodaAlmoSHks:blocname"..msg.chat_id_) or ""
if names_BodaAlmoSHks and names_BodaAlmoSHks[1] then 
for i=1,#names_BodaAlmoSHks do 
if name_BodaAlmoSHks:match("(.*)("..names_BodaAlmoSHks[i]..")(.*)") then 
...
database:set(bot_id.."BodaAlmoSHks:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."BodaAlmoSHks:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."BodaAlmoSHks:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."BodaAlmoSHks:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."BodaAlmoSHks:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_BodaAlmoSHksa_new(BodaAlmoSHks1,BodaAlmoSHks2)
if BodaAlmoSHks2 and BodaAlmoSHks2.first_name_ then 
if BodaAlmoSHks2.first_name_:match("(.*)"..database:get(bot_id.."BodaAlmoSHks:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BodaAlmoSHks:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local BodaAlmoSHks_nnn = database:get(bot_id.."BodaAlmoSHks:nump"..msg.chat_id_) or 5
local BodaAlmoSHks_nnn2 = database:get(bot_id.."BodaAlmoSHks:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(BodaAlmoSHks_nnn2) == tonumber(BodaAlmoSHks_nnn) or tonumber(BodaAlmoSHks_nnn2) > tonumber(BodaAlmoSHks_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."BodaAlmoSHks:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..BodaAlmoSHks2.username_.."](https://t.me/"..(BodaAlmoSHks2.username_ or "BO6OK")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BodaAlmoSHks:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(BodaAlmoSHks_nnn) - tonumber(BodaAlmoSHks_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_BodaAlmoSHksa_new)
end
end
...
local BodaAlmoSHksChengName = database:get(bot_id.."BodaAlmoSHks:Cheng:Name"..data.id_)
if not data.first_name_ then 
if BodaAlmoSHksChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BodaAlmoSHksChengName..']')
database:del(bot_id.."BodaAlmoSHks:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if BodaAlmoSHksChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."BodaAlmoSHks:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local BodaAlmoSHksChengUserName = database:get(bot_id.."BodaAlmoSHks:Cheng:UserName"..data.id_)
if not data.username_ then 
if BodaAlmoSHksChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BodaAlmoSHksChengUserName..']')
database:del(bot_id.."BodaAlmoSHks:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BodaAlmoSHksChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."BodaAlmoSHks:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BodaAlmoSHksChengPhoto = database:get(bot_id.."BodaAlmoSHks:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BodaAlmoSHksChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."BodaAlmoSHks:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if BodaAlmoSHksChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."BodaAlmoSHks:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
  ...
  ↬ .BodaAlmoSHks TEAM  
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ↬ . [Channel](t.me/bostatalmshks)  
  
  ↬ . [DEVELOPER](t.me/JJEJJ)       
   
  ↬ . [Information](t.me/bostatalmshks) 
...
if text == 'رفع نسخه الاحتياطيه' and DevBodaAlmoSHksW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevBodaAlmoSHksW(msg) then    
dofile('BodaAlmoSHks.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevBodaAlmoSHksW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBodaAlmoSHksW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevBodaAlmoSHksW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevBodaAlmoSHksW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBodaAlmoSHksW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevBodaAlmoSHksW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevBodaAlmoSHksW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBodaAlmoSHksW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevBodaAlmoSHksW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevBodaAlmoSHksW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevBodaAlmoSHksW(msg) then
...
if text == 'الملفات' and DevBodaAlmoSHksW(msg) then
t = ' ❃∫ ملفات السورس بودا ↓\n≪━━━━━━𝑩𝑳━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevBodaAlmoSHksW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BodaAlmoSHksTEAM/Files_BodaAlmoSHks/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات بودا\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝑩𝑳━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝑩𝑳━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس بودا ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/bostatalmshks) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevBodaAlmoSHksW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/BodaAlmoSHksTEAM/Files_BodaAlmoSHks/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BodaAlmoSHks.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس بودا \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevBodaAlmoSHksW(msg) then
...
if text == "مسح الملفات" and DevBodaAlmoSHksW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevBodaAlmoSHksW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBodaAlmoSHksW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_BodaAlmoSHks(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BodaAlmoSHks, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_BodaAlmoSHks, nil)
return false 
end
...
if text == 'تفعيل جلب النسخه' and DevBodaAlmoSHksW(msg) then  
  database:setex(bot_id.."send:file:Groups1",18000,true) 
send(msg.chat_id_, msg.id_,'❃∫ تم تفعيل جلب النسخه الاحتياطيه')
return false
end

if text == 'تعطيل جلب النسخه' and DevBodaAlmoSHksW(msg) then  
...
database:set(bot_id.."BodaAlmoSHks1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BodaAlmoSHks1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BodaAlmoSHks1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BodaAlmoSHks1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BodaAlmoSHks1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BodaAlmoSHks1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."BodaAlmoSHks1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BodaAlmoSHks1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BodaAlmoSHks1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BodaAlmoSHks1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."BodaAlmoSHks1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BodaAlmoSHks1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BodaAlmoSHks1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BodaAlmoSHks1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BodaAlmoSHks1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."BodaAlmoSHks1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BodaAlmoSHks1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BodaAlmoSHks1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BodaAlmoSHks1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝑩𝑳━━━━━━≫\n"
for k,v in pairs(list) do  
local BodaAlmoSHks_Msg = database:get(bot_id.."BodaAlmoSHks1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BodaAlmoSHks_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevBodaAlmoSHksW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevBodaAlmoSHksW(msg) then
...
if text == 'تفعيل الاذاعه' and DevBodaAlmoSHksW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBodaAlmoSHksW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بودا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بودا')
local BodaAlmoSHks_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..BodaAlmoSHks_Msg[math.random(#BodaAlmoSHks_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevBodaAlmoSHksW(msg) then 
...
},function(ta,BodaAlmoSHks)
local t = "\nツ قائمة الاعضاء \n≪━━━━━━𝑩𝑳━━━━━━≫\n"
x = 0
local list = BodaAlmoSHks.members_
for k, v in pairs(list) do
x = x + 1
...
if text == ("مسح ردود المطور") and DevBodaAlmoSHksW(msg) then 
...
if text == ("ردود المطور") and DevBodaAlmoSHksW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝑩𝑳━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevBodaAlmoSHksW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevBodaAlmoSHksW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بودا').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevBodaAlmoSHksW(msg) then   
...
if text == 'تعطيل المغادره' and DevBodaAlmoSHksW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BodaAlmoSHks')..') '
...
-- vardump(data) 
BodaAlmoSHksdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevBodaAlmoSHksW(msg) then
...
return false
  ...
  local Text =[[
    ...
    *❃م10 ◂ اوامر الاعضاء*
    ٴ≪━━━━━━𝑩𝑳━━━━━━≫ٴ
    彡 .[𝑩𝑶𝑫𝑨.𝑨𝑳𝑴𝑺𝑯𝑲𝑺 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/bostatalmshks)➢ 
  ]]
  keyboard = {} 
  ...
  {
  {text = '𝑩𝑶𝑫𝑨 {𝑹} 𝑻𝑬𝑨𝑴 , url="t.me/BodaAlmshks"},
  },
  }
...
zh = https.request('https://rudi-dev.tk/Amir1/BodaAlmoSHks.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝑩𝑳━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝑩𝑳━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝑩𝑶𝑫𝑨.𝑨𝑳𝑴𝑺𝑯𝑲𝑺 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/bostatalmshks)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/BodaAlmoSHks.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/BodaAlmoSHks.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
if data.ID == "UpdateNewCallbackQuery" then
  ...
  local Teext =[[
    ...
    ⌯︙ تنظيف الكروبات
    •━━━━━━━━━━━━━•ٴ
    彡 .[𝑩𝑶𝑫𝑨.𝑨𝑳𝑴𝑺𝑯𝑲𝑺 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/BodaAlmshks)➢
  ]]
  keyboard = {} 
  keyboard.inline_keyboard = {
  {
  ...
  local Teext =[[
    ...
    ⌯︙ تحا
    •━━━━━━━━━•ٴ
    彡 .[𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/bostatalmshks)➢
  ]]
  keyboard = {} 
  keyboard.inline_keyboard = {
  {
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بودا')
...
BodaAlmoSHks = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BodaAlmoSHks)
...
--------------------------------------------------------------------------------------------------------------
SourceBodaAlmoSHks(data.message_,data)
...
------------------------------------------------------------------------
local BodaAlmoSHksAbot = database:get(bot_id.."BodaAlmoSHks1:Add:Filter:Rp2"..text..result.chat_id_)   
if BodaAlmoSHksAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..BodaAlmoSHksAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local BodaAlmoSHks1_Msg = database:get(bot_id.."BodaAlmoSHks1:Add:Filter:Rp2"..text..result.chat_id_)   
if BodaAlmoSHks1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..BodaAlmoSHks1_Msg)
